...
A continuación, se presentan las comparaciones longitudinales de a pares para los tres indicadores seleccionados (\textit{PBI per cápita real}, \textit{Índice de felicidad / Escalera de Cantril} e \textit{Índice de Desarrollo Humano}) y, posteriormente, el análisis de la evolución simultánea de las tres dimensiones para el caso de India.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{output/figures/02_gdp_india_vs_usa.pdf}
...
\subsection{Índice de Felicidad (Escalera de Cantril)}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{output/figures/03_happiness_india_vs_usa.pdf}
    \caption{Satisfacción de Vida Autopercibida (Escalera de Cantril): India vs. Estados Unidos (2011--2025).}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{output/figures/01_hdi_india_vs_usa.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.88\textwidth]{output/figures/04_happiness_india.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth]{output/figures/05_hdi_and_gdp_india.pdf}
    \caption{Crecimiento Económico y Desarrollo Humano en India (1960--2025).}
    \label{fig:hdi_gdp_ind}
\end{figure}

Al comparar el Índice de Desarrollo Humano con el PBI per cápita (Figura \ref{fig:hdi_gdp_ind}), observamos un desacople entre las tasas de crecimiento de ambas series. A partir de los años 2000, el PBI per cápita creció de manera exponencial, mientras que el IDH mantuvo una trayectoria mucho más constante. 

Sumando ahora el índice de felicidad a este análisis, la correlación entre los tres indicadores resulta débil: mientras que el PBI per cápita y el IDH muestran una asociación positiva razonable ---ambos crecen de forma sostenida, aunque a ritmos distintos---, la felicidad se mueve de manera prácticamente independiente, e incluso en sentido contrario durante buena parte del período analizado.
